...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        #沙箱接口
        if tableName.lower()=="jdcommentdata":
            urlpatterns.extend(
                  [
...
urlpatterns.extend(
    [
        path(r'shive/analyze', shive_v.shive_analyze),
