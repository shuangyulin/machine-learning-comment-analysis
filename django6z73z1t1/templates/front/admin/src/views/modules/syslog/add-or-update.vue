<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-else-if="ruleForm.params" label="请求参数" prop="params" >
				<span class="text">{{ruleForm.params}}</span>
			</el-form-item>
