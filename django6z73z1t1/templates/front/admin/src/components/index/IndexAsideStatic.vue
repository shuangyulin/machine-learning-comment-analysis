...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item {
		...
		color: #888 !important;
		background: url(http://codegen.caihongy.cn/20241006/09c719bb1ef1405993960e59791718f9.png) no-repeat 20px top / auto 60% !important;
		width: 100% !important;
		font-size: inherit !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item:hover {
		color: #4dc2de !important;
		background: url(http://codegen.caihongy.cn/20241006/5c550aa9cd5e48af927dd292cb2aab4e.png) no-repeat 20px top / auto 60% !important;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item {
		...
		color: #888;
		background: url(http://codegen.caihongy.cn/20241006/09c719bb1ef1405993960e59791718f9.png) no-repeat 20px top / auto 60%;
		width: 100%;
		font-size: inherit;
		line-height: 40px;
		transition: all 0s;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item:hover {
		color: #4dc2de;
		background: url(http://codegen.caihongy.cn/20241006/5c550aa9cd5e48af927dd292cb2aab4e.png) no-repeat 20px top / auto 60%;
	}
