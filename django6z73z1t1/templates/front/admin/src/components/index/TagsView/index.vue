<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"10px 20px 0","margin":"30px auto 0","borderColor":"#d8dce5","borderRadius":"6px","background":"#fff","borderWidth":"0px","display":"block","width":"calc(100% - 80px)","borderStyle":"solid","height":"auto"}'>
