<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 220px","margin":"0","position":"relative","background":"#e3e8e9","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 0px 0px rgba(0, 0, 0, .3)","padding":"0px 10px 0 0","alignItems":"center","color":"#fff","display":"flex","justifyContent":"flex-end","top":"20px","borderRadius":"10px","left":"40px","background":"#4dc2de","width":"calc(100% - 80px)","fontSize":"15px","position":"inherit","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"40px 0px 0","margin":"0px auto 0 40px","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"none","display":"none","width":"auto","fontSize":"16px","borderStyle":"solid","zIndex":"1001"}' class="bread-crumbs"></bread-crumbs>
